        ...
        <div className="flex flex-col bg-white text-black py-12 px-10 rounded-[30px] justify-center items-center text-center w-[800px]">
            {isLoginRegister ? (
                <div className="flex flex-col">
                    ...
                    <button onClick={toggleLogin} className="bg-[#23aec0] text-white font-bold rounded py-1 mb-4">Entre</button>
                    <button onClick={toggleRegister} className="bg-[#1e9a9e] text-white font-bold rounded py-1">Cadastre-se</button>
                </div>
            ) : (
                <div>
                    {isLogin && (
